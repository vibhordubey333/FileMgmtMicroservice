...
timeout 5:
docker:
	 docker build -f ./filemanagement/build/Dockerfile -t filemgmt .
compose:
	 docker-compose -f ./filemanagement/build/docker-compose.yml up -d
remove:
	 docker container stop filemgmtservice mongoservice
	yes |  docker-compose -f ./filemanagement/build/docker-compose.yml rm
...
status:
	...
	docker images
	#############################################
	docker-compose -f ./filemanagement/build/docker-compose.yml ps
