...
//go:generate swagger generate server --target ..\..\filemanagement --name Filemanagement --spec ..\api\filemgmt_swagger.yml --principal interface{}

func configureFlags(api *operations.FilemanagementAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.FilemanagementAPI) http.Handler {
